...
import { FaAward, FaRegCalendar, FaRegImage } from "react-icons/fa6";
import { FaExternalLinkAlt } from "react-icons/fa";

import { Button } from "@/components/ui/button";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import { awardsGrants } from "@/data/awardsGrants";

interface AwardsGrantsSectionProps {
  variant?: string;
}

const TITLE = "Awards & Grants";

export default function AwardsGrantsSection({
  variant = "default",
}: AwardsGrantsSectionProps) {
  if (variant === "card") {
    return (
...
function AwardsGrantsContent() {
  ...
  const groupedItems = awardsGrants.reduce<Record<string, typeof awardsGrants>>(
    (acc, item) => {
